  ...
  return (
    <form className="min-w-full max-w-md mx-auto mt-4 p-10 bg-white shadow-md bg-snow">
        <div className="flex flex-col">
          <label htmlFor="fullname" className="py-6 bg-white text-black text-sm uppercase tracking-normal font-medium">Title of your blog post:</label>
          <input 
            type="text" 
            id="title" 
        ...
        <div className="flex flex-col">
            <label htmlFor="fullname" className="py-6 bg-white text-black text-sm uppercase tracking-normal font-medium">Type your words below:</label>
            <textarea
              id="content" 
              cols="2" 
              rows="20" 
